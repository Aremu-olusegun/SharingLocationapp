const LoginForm = ({username, setUsername, onClickHandler, disabled}) => {
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" action="#" method="POST">
              ...
              <div>
                ...
                >
                  {!disabled ? "Sign in" : "Enter Username"}
                </button>
              </div>
            </form>
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              Not a member?{' '}
              <a href="http://" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
